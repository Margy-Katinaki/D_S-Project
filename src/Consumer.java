import java.util.*;
/**import com.example.eventdeliverysystem.musicfilehandler.MusicFileHandler;
...
public class Consumer {
    ...
    public int register(Pair<String, BigInteger> credentials, Pair<String, Integer> extra) {
        ...
        try {
            ...
            if (message.equals("EXISTS_U")) {
                ...
                Utilities.printError("CONSUMER: REGISTER: This username already exists.Choose another.");
                disconnect(connection);
                return -1;
            } else if (message.equals("EXISTS_E")) {
                //EMAIL ALREADY EXISTS RETURN -2
                Utilities.printError("CONSUMER: REGISTER: This email already exists.Use another.");
                disconnect(connection);
                return -2;
            ...
            Utilities.printError("CONSUMER: REGISTER: ERROR: Could not get strams.");
    ...
    public ArrayList<VideoFile> playData(String channelN, String videoN, String mode) {
        Utilities.print("CONSUMER: Video request");
        ...
        try {
            ...
            if (channels == null || channels.isEmpty()) {
                ...
                switch (message) {
                    ...
                    case "FAILURE":
                        Utilities.printError("Publisher doesn't exist.");
                        disconnect(connection);
                        return null;
            ...
            if (brokerIP == null) {
                Utilities.printError("Publisher dosen't exist.");
                return null;
            }
            Socket connection = new Socket(SERVER_IP, PORT);
            //REQUEST VIDEO
            ...
            Utilities.printError("CONSUMER: PLAY: ERROR: Could not grt strams.");
        } catch (IOException e) {
    ...
    private void getBrokers(ObjectInputStream in){
        try{
            ...
            Utilities.printError("CONSUMER: BROKERS: ERROR: Could not get streams.");
        }catch (ClassNotFoundException e){
            Utilities.printError("CONSUMER: BROKERS: ERROR: Could not cast Object to HashMap.");
        }
    }
